    ...
    const allBlogs = [
        {
            ...
            That’s the joy I’ve found in Software Engineering. When an idea strikes, I jot it down—what could be fun to build? What seems solvable? What’s just plain silly? There’s no box telling me what it should look like. No price tag, no missing manual—only time. Limitless.\n
            Sure, some would argue time *is* a limiting resource—along with budget, team bandwidth, scalability. And they’re right, but that’s a difference in marketability and business which I won’t claim to know anything about. But deep down, at the heart of it, programming still feels like a bin of Legos. Toss in a few concepts, a few tools, maybe an API or two. Piece them together. See what clicks. It’s not always how I approach every project, but I think you get the idea.\n
            Legos are limited by the number of bricks in the bin. But programming? It feels infinite. The only real constraints are the ones we put on ourselves. My knowledge now is just a fraction of what’s to come. New tech emerges as fast as new Lego sets hit the shelves.\n
            Ever notice how ChatGPT and Lego Table Football were launched on the same day? Coincidence? Maybe. But it feels like the world keeps handing us new bricks to build with.\n
            With these new bricks—these new skills—I spend my days writing code, building features, committing to git. And just like back then, I sit back and admire what I’ve built. I let ideas flow. I let failure teach me. I pout, I debug, I rebuild. And when the day’s done, I toss the old version back into the bin—ready to start again tomorrow.
            `,
        },
        {
        ...
        },
        {
            ...
            'subtitle': '',
            'date': 'June 22, 2024',
            'images': Object.values(import.meta.glob('../../public/KitchenFindsPics/*.png',{eager: true, import: 'default'})),
            'text': `\n
        ...
        },
        {
            ...
            'subtitle': '',
            'date': 'April 16, 2024',
            'images': Object.values(import.meta.glob('../../public/ApposeScreenShots/*.png', {eager: true, import: 'default'})),
            'text': `\n
