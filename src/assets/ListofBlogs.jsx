    ...
    const allBlogs = [
        {
            ...
            'subtitle': '',
            'date': 'April 16, 2024',
            'images': Object.keys(import.meta.glob('/ApposeScreenShots/*.png', {eager: true, import: 'default'})),
            'text': `\n
        ...
        },
        {
            ...
            'subtitle': '',
            'date': 'June 22, 2024',
            'images': Object.keys(import.meta.glob('../../KitchenFindsPics/*.png',{eager: true, import: 'default'})),
            'text': `\n
